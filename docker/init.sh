...
echo "/usr/bin/php -d short_open_tag=1 ai-bolit-hoster.php --smart --addprefix=$CHECK_DIR_ALL --noprefix=/home/beget/site -p /home/beget/site -m 3096M --mode=$MODE --report=/home/report/$REPORT" >> /home/beget/aibolit/run.sh
