<?php
  ...
  $g_DBShe[] = 'zehirhacker';
  $g_DBShe[] = 'sypex';
  $g_DBShe[] = 'J@!Vr@*&RHRw~JLw.G|xlhnLJ~?1.bwObxbP|!V^Cx9���x�"P��bx~P';
  $g_DBShe[] = 'cihshell';
  ...
  $g_SusDB[] = '<iframe';
  $g_SusDB[] = 'phpinfo()';
  $g_SusDB[] = 'eval(gzuncompress(base64_decode';
  $g_SusDB[] = 'eval(base64_decode';
  $g_SusDB[] = 'SHOW DATABASES';
  $g_SusDB[] = 'posix_getpwuid';
  $g_SusDB[] = '$default_use_ajax';
  $g_SusDB[] = 'eval(unescape';
  $g_SusDB[] = 'document.write(unescape';

  print '$g_SusDB = unserialize(base64_decode("' . base64_encode(serialize($g_SusDB)) . '"));<br>';
  ...
  $g_AdwareSig[] = '->SLClient';
  $g_AdwareSig[] = 'isset($_SERVER[\'HTTP_USER_AGENT\']) && ($_SERVER[\'HTTP_USER_AGENT\'] == \'LMP_Robot';

  print '$g_AdwareSig = unserialize(base64_decode("' . base64_encode(serialize($g_AdwareSig)) . '"));<br>';
